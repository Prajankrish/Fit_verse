  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-coral-teal text-primary-foreground shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 font-semibold",
        electric: "bg-electric text-electric-foreground hover:bg-electric/90 shadow-md shadow-electric/20",
        purple: "bg-purple text-purple-foreground hover:bg-purple/90 shadow-md shadow-purple/20",
        glass: "glass border border-border/50 text-foreground hover:bg-accent/80",
      },
      size: {
